...
class FtpInfo:
    def __init__(self, host='202.127.202.6', usr='RADCALNET', psd='1Q2W3E4R'):
        self.ftp_host = host
        self.ftp_usr = usr
        self.ftp_psd = psd
    ...
    def set_para(self, host='202.127.202.6', usr='RADCALNET', psd='1Q2W3E4R'):
        """
        设置ftp服务器登录参数
...
class SqlInfo:
    ...
    def set_para(self, db_driver='mysql+mysqlconnector', db_usr='root', db_psd='1q2w3e4r', db_host='118.31.70.60',
                 db_port='3306',
                 db_name='Level0'):
        self.db_driver = db_driver
        self.db_usr = db_usr
